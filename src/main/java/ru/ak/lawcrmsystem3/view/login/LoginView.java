package ru.ak.lawcrmsystem3.view.login;
...
public class LoginView extends StandardView implements LocaleChangeObserver {
    ...
    public void onLogin(final LoginEvent event) {
        try {
            ...
            // Добавляем имя пользователя в VaadinSession
            ...
            UI.getCurrent().navigate("http://localhost:8080/kanban-view"); // Замените "main" на URL вашей главной страницы
